...
ANT_stop_word::ANT_stop_word() {
	qsort (ANT_stop_word_list, ANT_stop_word_list_len, ANT_stop_word_list_len, (int(*)(const void*,const void*)) strcmp);
}
...
{
if (bsearch(&term, ANT_stop_word_list, ANT_stop_word_list_len, ANT_stop_word_list_len, (int(*)(const void*,const void*)) strcmp) == NULL)
	return 0;
