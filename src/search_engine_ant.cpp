...
search_engine_ant::search_engine_ant(const char *doclist_filename, const char *index_filename, bool segmentation)
	: index_filename_(index_filename), doclist_filename_(doclist_filename)
{
//	if (sys_file::exist(ANT_CONFIG_FILE))
//		config_ant_ = new QLINK::config(ANT_CONFIG_FILE);
//	else
//		config_ant_ = NULL;
//
//	docids_ = NULL;
...
//	ant_params(ant_)->segmentation = segmentation;
//
//	ant_setup(ant_);
}
